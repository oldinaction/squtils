package cn.aezo.utils.io.excel.sax;
...
/**
 * Created by smalle on 2017/4/11.
 */
public class ExcelSax {
    ...
    private static class Sax {
        ...
        public Sax(String filename,int startRow,int endRow) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ExcelSax.Sax reader = new ExcelSax.Sax("C:/Users/smalle/Desktop/out_plan_boxmanager.xls", 1, 100);
