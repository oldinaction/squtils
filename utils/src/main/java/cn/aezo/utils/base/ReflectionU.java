...
public class ReflectionU {
    ...
    private static Log logger = LogFactory.getLog(ReflectionU.class);
    ...
    protected static Field getDeclaredField(final Object object,
                                            final String fieldName) {
        if(object == null) throw new RuntimeException("object不能为空");
        if(StringUtils.isBlank(fieldName)) throw new RuntimeException("fieldName不能为空");
